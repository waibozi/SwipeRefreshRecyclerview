...
//        mSwipeListener = listener;
    ...
    /**
     * 设置点击事件，onRowClicked为Item点击事件
     * onIndependentViewClicked为独立控件点击事件
     *
     * @param listener
     * @return
     */
    ...
    /**
     * 设置长按点击，需要申请 <uses-permission android:name="android.permission.VIBRATE" /> 权限
     *
     * @param vibrate
     * @param listener
     * @return
    ...
    /**
     * 设置独立的的控件，会触发onIndependentViewClicked监听
     *
     * @param viewIds
     * @return
     */
    ...
    /**
     *
     * @param foregroundID  上层布局
     * @param backgroundID  菜单布局
     * @param listener 菜单点击监听
     * @return
     */
...
//            bgWidth = rView.getWidth();
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (rView instanceof SwipeRefreshRecyclerView) {
                    refreshEnable = ((SwipeRefreshRecyclerView) rView).getPullRefreshEnabled();
                }
...
//                        bgView.getLayoutParams().height = fgView.getHeight();
            ...
            case MotionEvent.ACTION_CANCEL: {
                if (rView instanceof SwipeRefreshRecyclerView) {
                    if (refreshEnable)
                        ((SwipeRefreshRecyclerView) rView).setPullRefreshEnabled(true);
                }
                handler.removeCallbacks(mLongPressed);
...
//                float absVelocityY = Math.abs(mVelocityTracker.getYVelocity());
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (swipeable && isFgSwiping) {
                    if (rView instanceof SwipeRefreshRecyclerView) {
                        if (refreshEnable)
                            ((SwipeRefreshRecyclerView) rView).setPullRefreshEnabled(false);
                    }
                }
